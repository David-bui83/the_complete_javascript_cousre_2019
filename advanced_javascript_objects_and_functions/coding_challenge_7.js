...
c) correct answer (I wuold use a number for this)
...
the correct answer such as you display it on the task 4.

6. Check if the answer is correct and print to the console whether the answer is corret or not (Hint:
...
your code is private and doesn't interfere with the other programmer's code (Hint: we learned a special
technique to do exactly that).

8. After your display the reult, display the next random question, so that the game never ends (Hint:
write a function for this and call it right after the displaying the result)

9. Be careful: after task 8, the game literally never ends. So include the option to quit the game if the 
user writes 'exit' instead of the answer. In this case, DON'T call teh function from task 8.

10. Track the user's score to make the game more fun! So each time an answer is correct, add 1 point to 
the score (Hint: I'm going to use the power of closure for this, but you don't have to, just do this
...
(function(){
    ...
    var q2 = new Question('What is the name of the this course\'s teacher?', ['John', 'Michael', 'Jonas'], 2);
